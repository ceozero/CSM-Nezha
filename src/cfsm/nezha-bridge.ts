	...
	return {
		...
		state: {
			...
			network_latency: {
				...
				node_1: toNetworkProbe(server.ping_node_1, server.loss_node_1),
				node_2: toNetworkProbe(server.ping_node_2, server.loss_node_2),
				node_3: toNetworkProbe(server.ping_node_3, server.loss_node_3),
				node_4: toNetworkProbe(server.ping_node_4, server.loss_node_4),
			},
			temperatures: [],
